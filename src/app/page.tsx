...
import { Camera, Heart, Users, Award, MapPin, Gem, Flower, Sparkles, Bell } from 'lucide-react'; // Replaced Rings with Gem
    ...
    <div className="flex flex-col min-h-dvh bg-background"> {/* Use background color */}
      ...
      <section className="relative h-[70vh] md:h-[85vh] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <Image
          ...
          objectFit="cover"
          quality={85}
          className="absolute inset-0 z-0 filter brightness-75" // Slightly darker for better text contrast
          priority
          data-ai-hint="wedding ceremony couple tradition"
          aria-hidden="true"
        />
        {/* Subtle Pastel Overlay (Mint Green tint) */}
        <div className="absolute inset-0 bg-gradient-to-t from-primary/20 via-primary/5 to-transparent z-10"></div>
        {/* Hero Content */}
        <div className="relative z-20 p-6 md:p-8 animate-fade-in-slow max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-bold mb-4 drop-shadow-lg text-white"> {/* Ensure text color is white */}
            Dream Captures
          </h1>
           <p className="text-2xl md:text-3xl font-baloo text-accent mb-8 drop-shadow-md" lang="te"> {/* Accent Pink */}
             ప్రతి ఫోటోలో ఒక అందమైన గుర్తు...
          </p>
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto drop-shadow text-gray-200"> {/* Ensure text color is light */}
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <Button asChild size="lg" variant="secondary" className="font-semibold px-8 py-3 rounded-full shadow-lg transition-transform duration-300 hover:scale-105 w-full sm:w-auto">
      ...
      <section className="py-16 md:py-24 bg-background" aria-labelledby="about-teaser-heading">
        <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-[4/3] max-w-md mx-auto md:mx-0 rounded-lg overflow-hidden shadow-xl border-4 border-accent/30 order-1 md:order-none"> {/* Teal border */}
             <Image
      ...
      {/* Portfolio Teaser - Light pastel background (e.g., Primary tint) */}
       <section className="py-16 md:py-24 bg-primary/5" aria-labelledby="portfolio-teaser-heading"> {/* Muted Sand/Beige tint background */}
        ...
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {testimonials.map((testimonial) => (
              <Card key={testimonial.id} className="text-left shadow-lg border border-border hover:shadow-xl transition-shadow bg-card rounded-xl overflow-hidden"> {/* Softer border */}
      ...
      <section className="py-16 md:py-24 bg-accent/5" aria-labelledby="services-teaser-heading"> {/* Teal tint */}
        <div className="container mx-auto px-4 md:px-6 text-center">
          <h2 id="services-teaser-heading" className="text-3xl md:text-4xl font-serif font-semibold mb-4 text-foreground">Our Signature Services</h2>
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto mb-10">
             ...
             <Card className="text-center shadow-lg hover:shadow-xl transition-shadow border border-border rounded-xl overflow-hidden transform hover:-translate-y-1 flex flex-col">
               <CardHeader className="bg-gradient-to-br from-primary/10 to-accent/10 p-6"> {/* Maroon/Teal tint bg */}
              ...
              <Card className="text-center shadow-lg hover:shadow-xl transition-shadow border border-border rounded-xl overflow-hidden transform hover:-translate-y-1 flex flex-col">
                <CardHeader className="bg-gradient-to-br from-secondary/10 to-yellow-100 p-6"> {/* Maroon/Gold tint bg */}
              ...
              <Card className="text-center shadow-lg hover:shadow-xl transition-shadow border border-border rounded-xl overflow-hidden transform hover:-translate-y-1 flex flex-col">
                <CardHeader className="bg-gradient-to-br from-accent/10 to-yellow-100 p-6"> {/* Teal/Gold tint bg */}
             ...
             {/* Service Card 4: Outdoor Sessions - Teal/Cyan Gradient */}
              <Card className="text-center shadow-lg hover:shadow-xl transition-shadow border border-border rounded-xl overflow-hidden transform hover:-translate-y-1 flex flex-col">
                <CardHeader className="bg-gradient-to-br from-teal-500/10 to-cyan-100 p-6"> {/* Teal/Cyan tint bg */}
       ...
       <section className="py-16 md:py-24 bg-background text-center" aria-labelledby="final-cta-heading">
         <div className="container mx-auto px-4 md:px-6">
            ...
            {/* Primary Button (Maroon) */}
             <Button asChild size="lg" variant="primary" className="rounded-full px-10 py-3 shadow-lg transition-transform duration-300 hover:scale-105">
